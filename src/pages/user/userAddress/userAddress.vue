            ...
            <div class="manage-address">
                <div class="insert">
                    ...
                    <div class="form" :style="formStyle">
                        <address-form @saveForm="saveForm" @cancelForm="cancelForm"></address-form>
                    </div>
                </div>
                <div class="address">
                    <ul class="clearfix">
                        <li class="default">
                            <div class="default-txt">默认地址</div>
                            <p>陈明</p>
                            <p>13776626715</p>
...
<script>
  ...
  const addressForm = () => import('./layout/addressForm')
  export default {
    components: {iMenu, addressForm},
    data () {
      return {
        showFormFlag: false
      }
    ...
    computed: {
      formStyle () {
        return {
          height: this.showFormFlag ? '612px' : '0',
          padding: this.showFormFlag ? '20px 80px' : '0 80px'
        }
      }
    },
    methods: {
...
<style lang="less">
    @import "../../../assets/styles/pages/userAddress";
</style>
