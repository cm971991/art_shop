    ...
    <div class="nav">
      ...
      <div class="search">
        <a @click="search($event)">
          <img src="https://www.ywart.com/svg_file?path=/Content/image/search.svg&amp;rgb=255,255,255" class="searchIcon" :class="{ active : searchFlag }">
          <img src="https://www.ywart.com/svg_file?path=/Content/image/closeInput.svg&amp;rgb=255,255,255" class="closeIcon" :class="{ active : !searchFlag }">
        </a>
      </div>
    </div>
    <div class="member">
